...
<head>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="skills">
							...
							<div class="progress-bar-linear">
								<p class="progress-bar-text">Cities Present </p>
								<div class="progress-bar">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12"> 
						<div class="feature_img">
							<img src="assets/img/women-laptop.png" class="img-responsive" alt="" />
						</div>
					</div><!--- END COL -->						
				</div><!--- END ROW -->			
			</div><!--- END CONTAINER -->		
	...
	<div class="section-title text-center wow zoomIn">
		...
		<!-- START NEWSLETTER -->
		<section class="newsletter" style="background-image: url(assets/img/bg/newsletter-bg.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;">
  ...
  <div class="modal-dialog bg-modal " >
	<div class="modal-content">
		<div class="modal-header bg-primary ">
			...
			<h3 class="modal-title text-white" id="lineModalLabel">BOOK APPOINTMENT</h3>
		</div>

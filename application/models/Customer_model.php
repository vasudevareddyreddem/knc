...
class Customer_model extends MY_Model
{
	...
	public function get_order_items($order_id){
		$this->db->select('order_items.*,products.item_name,products.description,products.item_image,products.product_code,products.brand,products.colour,products.ram,products.internal_memeory,sellers.seller_name,sellers.seller_mobile,sellers.seller_email,seller_store_details.store_name,billing_address.name')->from('order_items');
		$this->db->join('products', 'products.item_id = order_items.item_id', 'left');
		$this->db->join('sellers', 'sellers.seller_id = products.seller_id', 'left');
	...
	public function get_cart_products($cust_id){
		$this->db->select('cart.*,products.item_name,products.product_code,products.special_price,products.brand,products.item_image,products.ram,products.colour,products.internal_memeory,products.item_cost,products.offer_amount,products.offer_percentage,offer_amount,products.offer_combo_item_id,products.offer_type,products.offer_expairdate,products.item_quantity,seller_store_details.store_name')->from('cart');
	...
	public function get_customerBilling_details($order_tem_id){
		$this->db->select('products.item_name,products.ram,products.internal_memeory,products.colour,products.item_image,order_items.customer_phone,sellers.seller_email,sellers.seller_mobile,customers.cust_email,billing_address.name,order_items.*,order_status.cancel_date')->from('order_items');

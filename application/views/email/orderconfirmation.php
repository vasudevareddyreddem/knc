               ...
               <tbody> 
                <tr> 
                 <td  align="left" style="float:right;padding:0;text-align:center;vertical-align:middle">
					<h4><b style="color:#d32134">Order :</b><span >&nbsp; Placed</span></h4>
				 </td> 
                ...
                <tr> 
                 ...
                 <td  align="left"> 
					...
					?>						
					 ...
					 <br>
					  <a href="<?php echo base_url('customer/orederdetails/'.base64_encode($list['order_item_id']));?>" style="font-family:'Roboto-Medium',sans-serif;box-sizing:border-box;text-decoration:none;background-color:#d32134;color:#fff;min-width:160px;padding:7px 16px;border-radius:2px;text-align:center;display:inline-block;font-size:14px" target="_blank" >Track your Shipment</a> </td> 

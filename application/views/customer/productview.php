...
<div id="sucessmsg" style="display:none;"></div>
        ...
        <div class="col-md-8 col-md-offset-3 sm_mar_t20 card" id="con_scrol">
          ...
          <div class="title-detail pad-t20" style="text-transform: uppercase;"><?php echo $products_list['item_name']; ?></div>
		 ...
		 $currentdate=date('Y-m-d h:i:s A');
		   ...
		   <!-- <tr>
				...
				$customerdetails=$this->session->userdata('userdetails');  ?>
				  ...
				  <a href="" id="compare" class="btn btn-success m-b-1" type="button" ><i class="fa fa-align-left"></i> Add to Compare</a>
				...
				<?php 	if (in_array($products_list['item_id'], $whishlist_item_ids_list) &&  in_array($customerdetails['customer_id'], $customer_ids_list)  ) { ?>
					...
					<?php }else{ ?>	
					<a href="javascript:void(0);" onclick="addwhishlidt(<?php echo $products_list['item_id']; ?>);" id="addwhish" class="btn btn-warning m-b-1" type="button"><i class="fa fa-heart"></i>Add to Wishlist</a>  
					<?php } ?>			  
...
<?php if($products_list['item_quantity']>0 && $products_list['item_status']!=0 ){ ?>
        ...
        <div class="col-md-8 col-md-offset-3 card" style="margin-top:10px;padding:0">
			...
			<table class="table table-bordered">
				...
				<tbody>
				  ...
				  <tr>
					<td>
						<div class="row">
							<p class="pad-15"><?php echo isset($products_list['highlights'])?$products_list['highlights']:''; ?></p>
						</div>
					</td>

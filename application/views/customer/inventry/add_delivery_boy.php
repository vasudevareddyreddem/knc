		...
		<div class="container">
			<div class="row">
				<?php if($this->session->flashdata('addsuccess')){ ?>
					...
					<?php  endif;?>
				<form enctype="multipart/form-data" method="post" name="adddeliveryboy" id="adddeliveryboy"  action="<?php echo base_url('inventory/adddeliveryboypost'); ?>" class="well col-md-6 col-md-offset-2" style="background-color:#fff;">
				...
				<div class=""  style="font-size:20px;font-weight:600;border-bottom:1px solid #ddd;margin-bottom:10px;padding-bottom:10px;">Add Delivery Boy</div>

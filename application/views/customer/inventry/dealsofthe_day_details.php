    ...
    <!-- Content Header (Page header) -->
      ...
      <div class="box data_box_wid">
            <div class="box-header" style="border-bottom:1px solid #ddd;">
              <h3 class="box-title" >Seller Deals of the day Items List</h3>
              <a class="pull-right btn btn-sm btn-primary" href="<?php echo base_url('inventory/dealsoftheday'); ?>" class="box-title">Back</a>
            </div>
            <!-- /.box-header -->

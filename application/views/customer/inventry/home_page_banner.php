          ...
          <?php   //echo '<pre>';print_r($season_sales);exit; 
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>                  
                  ...
                  <td><a href="<?php echo base_url('inventory/sellerhomepagebannerdetails/'.base64_encode($offer['seller_id'])); ?>"><?php echo $offer['itemscount']; ?><?php if($offer['count'][0]['activecount']!=0){ ?>&nbsp;<span style="color:darkslateblue;">(<?php  echo $offer['count'][0]['activecount'];  ?> &nbsp; Item active)</span><?php }  ?></a></td>
				  <td><a href="<?php echo base_url('inventory/overaall_home_page_banner_status/'.base64_encode($offer['seller_id']).'/'.base64_encode(0)); ?>">All Active</a> &nbsp; | &nbsp;

      ...
      <div class="box data_box_wid">
            ...
            <div class="box-body"><?php if($this->session->flashdata('success')): ?>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php  
                  foreach($top_offers_details as $items) {
                ...
                <tr>                  
                  ...
                  <td>
				  <a href="<?php echo base_url('inventory/topoffers_home_page_status/'.base64_encode($items['seller_id']).'/'.base64_encode($items['item_id']).'/'.base64_encode($items['home_page_status'])); ?>"><?php if($items['home_page_status']==1){ echo "Active";}else{ echo "Deactive";} ?></a>
				 </td>                  

<div class="content-wrapper pad_t100">
      ...
      <div class="box ">
            <div class="box-header" style="border-bottom:1px solid #ddd;">
              <h3 class="box-title">Pending Orders List (<?php if(isset($orderslists) && count($orderslists)>0){echo count($orderslists); } ?>)</h3>
			...
			<?php if($this->session->flashdata('success')): ?>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<td><?php echo isset($list['store_name'])?$list['store_name']:''; ?></td>
					<td><?php echo isset($list['seller_location'])?$list['seller_location']:''; ?></td>
				<td>

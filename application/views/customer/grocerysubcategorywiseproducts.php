                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              ...
                              <div  class="input-group incr_btn pull-left">
                                 ...
                                 <input type="text" name="qty" id="qty<?php echo $cnt; ?><?php echo $cnt1; ?>" readonly  class="form-control input-number" value="1" min="1" max="<?php echo $productslist['item_quantity']; ?>">
                                 <span class="input-group-btn">
                                 <button style="width:20px;padding:6px" onclick="productqtyincreae('<?php echo $cnt; ?>','<?php echo $cnt1; ?>');" type="button" class="btn btn-primary btn-number btn-small" data-type="plus" data-field="quant[2]">
 ...
 function colouractive(val){
   ...
   if(itemid!=''){
     jQuery.ajax({
   		...
   		dataType: 'html',
   		success: function (data) {
   				$("#unitwusechanges"+cnt+time).empty();
   				$("#unitwusechanges"+cnt+time).append(data);
   		}
   	});
   ...
   var qtycnt=document.getElementById("qty"+id+anid).value;
   ...
   function productqtyincreae(id,anid){
   var pid=document.getElementById("product_id"+id).value;
   var qtycnt1=document.getElementById("qty"+id+anid).value;

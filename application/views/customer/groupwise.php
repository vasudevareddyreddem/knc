                  ...
                  <div class="panel panel-primary">
                     ...
                     <div id="collapseThree0" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree0">
                        <div class="panel-body">
                           ...
                           <div class="checkbox"><label><input type="checkbox" onclick="categorywisefilters(this.value, '<?php echo 'discount'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[discount][]" value="<?php echo $list['discount']; ?>"><span>&nbsp;<?php echo $list['discount']; ?></span></label></div>
                           <?php } ?>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="panel panel-primary">
                     ...
                     <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree45">
                        <div class="panel-body">
                           ...
                           <div class="checkbox"><label><input type="checkbox" onclick="categorywisefilters(this.value, '<?php echo 'colour'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[color][]" value="<?php echo $list['colour']; ?>"><span>&nbsp;<?php echo $list['colour']; ?></span></label></div>
                           <?php } ?>
                        </div>
                     </div>
                  </div>

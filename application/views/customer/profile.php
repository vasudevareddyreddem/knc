...
<?php if($this->session->flashdata('success')): ?>
  ...
  <div class="row">
    <div class="col-md-3" >
		<div>	
			<li class="list-group-item " style="border-top:2px solid #45b84a;">
        		<div class=" col-md-4">
		...
		<div class="panel panel-default">
		  <div class="panel-heading" style="background:#fff">
				...
				<div class="pull-right">
					<a href="<?php echo base_url('customer/editprofile'); ?>" class="btn btn-default btn-xs" style="border-radius:5px;">Edit</a>
				</div>
				<div class="clearfix"></div>
		  </div>

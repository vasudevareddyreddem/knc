...
.product-rateing{
 ...
 <div class="col-sm-3">
		  ...
		  <div class="row">
		  <div class="col-md-6">
		   <select class="form-control" name="mimimum_price" id="mimimum_price" onchange="itemwisefilters(this.value, '<?php echo 'mimimum_price'; ?>','<?php echo ''; ?>');">
                     ...
                     <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                           <?php foreach ($offer_list as $list){ 
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'offer'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[offers][]" value="<?php echo $list['offers']; ?>"><span>&nbsp;<?php echo number_format($list['offers'], 2, '.', ''); ?></span></label></div>
						<?php } else{  ?>
                           <div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'offer'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[offers][]" value="<?php echo $list['offers']; ?>"><span>&nbsp;<?php echo number_format($list['offers'], 2, '.', ''); ?></span></label></div>
                           <?php }  }?>
                        </div>
                     </div>
                  </div>
                     ...
                     <div id="collapseThree1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree2">
                        <div class="panel-body">
                           <?php foreach ($brand_list as $list){
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'brand'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[brand][]" value="<?php echo $list['brand']; ?>"><span>&nbsp;<?php echo $list['brand']; ?></span></label></div>
						<?php } else{  ?>
                           <div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'brand'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[brand][]" value="<?php echo $list['brand']; ?>"><span>&nbsp;<?php echo $list['brand']; ?></span></label></div>
                           <?php } } ?>
                        </div>
                     </div>
                  </div>
                     ...
                     <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree45">
                        <div class="panel-body">
                           <?php foreach ($color_list as $list){ 
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'colour'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[colour][]" value="<?php echo $list['colour']; ?>"><span>&nbsp;<?php echo $list['colour']; ?></span></label></div>
							<?php } else{  ?>
                           <div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'colour'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[colour][]" value="<?php echo $list['colour']; ?>"><span>&nbsp;<?php echo $list['colour']; ?></span></label></div>
                           <?php } } ?>
                        </div>
                     </div>
                  </div>
				...
				<div class="panel panel-primary">
					...
					<div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
						...
						<?php foreach ($sizes_list as $list){ 
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'size'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[size][]" value="<?php echo $list['size']; ?>"><span>&nbsp;<?php echo $list['size']; ?></span></label></div>
							<?php } else{  ?>
							<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'size'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[size][]" value="<?php echo $list['size']; ?>"><span>&nbsp;<?php echo $list['size']; ?></span></label></div>
				...
				<?php  } ?>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThreecomram">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'ram'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[ram][]" value="<?php echo $list['ram']; ?>"><span>&nbsp;<?php echo $list['ram']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'ram'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[ram][]" value="<?php echo $list['ram']; ?>"><span>&nbsp;<?php echo $list['ram']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseos" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingos">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'os'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[os][]" value="<?php echo $list['os']; ?>"><span>&nbsp;<?php echo $list['os']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'os'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[os][]" value="<?php echo $list['os']; ?>"><span>&nbsp;<?php echo $list['os']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapsesim_list" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingsim_list">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'sim_type'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[sim_type][]" value="<?php echo $list['sim_type']; ?>"><span>&nbsp;<?php echo $list['sim_type']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'sim_type'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[sim_type][]" value="<?php echo $list['sim_type']; ?>"><span>&nbsp;<?php echo $list['sim_type']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapsecamera" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingcamera">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'camera'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[camera][]" value="<?php echo $list['camera']; ?>"><span>&nbsp;<?php echo $list['camera']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'camera'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[camera][]" value="<?php echo $list['camera']; ?>"><span>&nbsp;<?php echo $list['camera']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseinternal_memeory" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headinginternal_memeory">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'internal_memeory'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[internal_memeory][]" value="<?php echo $list['internal_memeory']; ?>"><span>&nbsp;<?php echo $list['internal_memeory']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'internal_memeory'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[internal_memeory][]" value="<?php echo $list['internal_memeory']; ?>"><span>&nbsp;<?php echo $list['internal_memeory']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapsescreen_size" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingscreen_size">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'screen_size'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[screen_size][]" value="<?php echo $list['screen_size']; ?>"><span>&nbsp;<?php echo $list['screen_size']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'screen_size'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[screen_size][]" value="<?php echo $list['screen_size']; ?>"><span>&nbsp;<?php echo $list['screen_size']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'Processor'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[Processor][]" value="<?php echo $list['Processor']; ?>"><span>&nbsp;<?php echo $list['Processor']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'Processor'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[Processor][]" value="<?php echo $list['Processor']; ?>"><span>&nbsp;<?php echo $list['Processor']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor3" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor3">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'type'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[type][]" value="<?php echo $list['type']; ?>"><span>&nbsp;<?php echo $list['type']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'type'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[type][]" value="<?php echo $list['type']; ?>"><span>&nbsp;<?php echo $list['type']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor4" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor4">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'printer_type'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[printer_type][]" value="<?php echo $list['printer_type']; ?>"><span>&nbsp;<?php echo $list['printer_type']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'printer_type'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[printer_type][]" value="<?php echo $list['printer_type']; ?>"><span>&nbsp;<?php echo $list['printer_type']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor6" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor6">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'max_copies'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[max_copies][]" value="<?php echo $list['max_copies']; ?>"><span>&nbsp;<?php echo $list['max_copies']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'max_copies'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[max_copies][]" value="<?php echo $list['max_copies']; ?>"><span>&nbsp;<?php echo $list['max_copies']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor7" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor7">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'paper_size'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[paper_size][]" value="<?php echo $list['paper_size']; ?>"><span>&nbsp;<?php echo $list['paper_size']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'paper_size'; ?>','<?php echo ''; ?>');" id="checkbox1" name="products[paper_size][]" value="<?php echo $list['paper_size']; ?>"><span>&nbsp;<?php echo $list['paper_size']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor8" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor8">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'headphone_jack'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[headphone_jack][]" value="<?php echo $list['headphone_jack']; ?>"><span>&nbsp;<?php echo $list['headphone_jack']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'headphone_jack'; ?>','<?php echo ''; ?>');" id="headphone_jack" name="products[headphone_jack][]" value="<?php echo $list['headphone_jack']; ?>"><span>&nbsp;<?php echo $list['headphone_jack']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor9" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor9">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'noise_reduction'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[noise_reduction][]" value="<?php echo $list['noise_reduction']; ?>"><span>&nbsp;<?php echo $list['noise_reduction']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'noise_reduction'; ?>','<?php echo ''; ?>');" id="noise_reduction" name="products[noise_reduction][]" value="<?php echo $list['noise_reduction']; ?>"><span>&nbsp;<?php echo $list['noise_reduction']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor10" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor10">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'usb_port'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[usb_port][]" value="<?php echo $list['usb_port']; ?>"><span>&nbsp;<?php echo $list['usb_port']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'usb_port'; ?>','<?php echo ''; ?>');" id="usb_port" name="products[usb_port][]" value="<?php echo $list['usb_port']; ?>"><span>&nbsp;<?php echo $list['usb_port']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor11" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor11">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'compatible_for'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[compatible_for][]" value="<?php echo $list['compatible_for']; ?>"><span>&nbsp;<?php echo $list['compatible_for']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'compatible_for'; ?>','<?php echo ''; ?>');" id="compatible_for" name="products[compatible_for][]" value="<?php echo $list['compatible_for']; ?>"><span>&nbsp;<?php echo $list['compatible_for']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor12" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor12">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'scanner_type'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[scanner_type][]" value="<?php echo $list['scanner_type']; ?>"><span>&nbsp;<?php echo $list['scanner_type']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'scanner_type'; ?>','<?php echo ''; ?>');" id="scanner_type" name="products[scanner_type][]" value="<?php echo $list['scanner_type']; ?>"><span>&nbsp;<?php echo $list['scanner_type']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor13" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor13">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'resolution'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[resolution][]" value="<?php echo $list['resolution']; ?>"><span>&nbsp;<?php echo $list['resolution']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'resolution'; ?>','<?php echo ''; ?>');" id="resolution" name="products[resolution][]" value="<?php echo $list['resolution']; ?>"><span>&nbsp;<?php echo $list['resolution']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor14" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor14">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'f_stop'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[f_stop][]" value="<?php echo $list['f_stop']; ?>"><span>&nbsp;<?php echo $list['f_stop']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'f_stop'; ?>','<?php echo ''; ?>');" id="f_stop" name="products[f_stop][]" value="<?php echo $list['f_stop']; ?>"><span>&nbsp;<?php echo $list['f_stop']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor15" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor15">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'minimum_focusing_distance'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[minimum_focusing_distance][]" value="<?php echo $list['minimum_focusing_distance']; ?>"><span>&nbsp;<?php echo $list['minimum_focusing_distance']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'minimum_focusing_distance'; ?>','<?php echo ''; ?>');" id="minimum_focusing_distance" name="products[minimum_focusing_distance][]" value="<?php echo $list['minimum_focusing_distance']; ?>"><span>&nbsp;<?php echo $list['minimum_focusing_distance']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor16" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor16">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'aperture_withmaxfocal_length'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[aperture_withmaxfocal_length][]" value="<?php echo $list['minimum_focusiaperture_withmaxfocal_lengthng_distance']; ?>"><span>&nbsp;<?php echo $list['aperture_withmaxfocal_length']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'aperture_withmaxfocal_length'; ?>','<?php echo ''; ?>');" id="aperture_withmaxfocal_length" name="products[aperture_withmaxfocal_length][]" value="<?php echo $list['aperture_withmaxfocal_length']; ?>"><span>&nbsp;<?php echo $list['aperture_withmaxfocal_length']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor17" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor17">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'picture_angle'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[picture_angle][]" value="<?php echo $list['picture_angle']; ?>"><span>&nbsp;<?php echo $list['picture_angle']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'picture_angle'; ?>','<?php echo ''; ?>');" id="picture_angle" name="products[picture_angle][]" value="<?php echo $list['picture_angle']; ?>"><span>&nbsp;<?php echo $list['picture_angle']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor19">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'weight'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[weight][]" value="<?php echo $list['weight']; ?>"><span>&nbsp;<?php echo $list['weight']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'weight'; ?>','<?php echo ''; ?>');" id="weight" name="products[weight][]" value="<?php echo $list['weight']; ?>"><span>&nbsp;<?php echo $list['weight']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor20" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor20">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'occasion'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[occasion][]" value="<?php echo $list['occasion']; ?>"><span>&nbsp;<?php echo $list['occasion']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'occasion'; ?>','<?php echo ''; ?>');" id="occasion" name="products[occasion][]" value="<?php echo $list['occasion']; ?>"><span>&nbsp;<?php echo $list['occasion']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor21" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor21">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'material'; ?>','<?php echo 'uncheck'; ?>');" id="checkbox1" name="products[material][]" value="<?php echo $list['material']; ?>"><span>&nbsp;<?php echo $list['material']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'material'; ?>','<?php echo ''; ?>');" id="material" name="products[material][]" value="<?php echo $list['material']; ?>"><span>&nbsp;<?php echo $list['material']; ?></span></label></div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor22" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor22">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'collar_type'; ?>','<?php echo 'uncheck'; ?>');" id="collar_type" name="products[collar_type][]" value="<?php echo $list['collar_type']; ?>"><span>&nbsp;<?php echo $list['collar_type']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'collar_type'; ?>','<?php echo ''; ?>');" id="collar_type" name="products[collar_type][]" value="<?php echo $list['collar_type']; ?>"><span>&nbsp;<?php echo $list['collar_type']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor23" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor23">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'gender'; ?>','<?php echo 'uncheck'; ?>');" id="gender" name="products[gender][]" value="<?php echo $list['gender']; ?>"><span>&nbsp;<?php echo $list['gender']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'gender'; ?>','<?php echo ''; ?>');" id="gender" name="products[gender][]" value="<?php echo $list['gender']; ?>"><span>&nbsp;<?php echo $list['gender']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor24" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor24">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'sleeve'; ?>','<?php echo 'uncheck'; ?>');" id="sleeve" name="products[sleeve][]" value="<?php echo $list['sleeve']; ?>"><span>&nbsp;<?php echo $list['sleeve']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'sleeve'; ?>','<?php echo ''; ?>');" id="sleeve" name="products[sleeve][]" value="<?php echo $list['sleeve']; ?>"><span>&nbsp;<?php echo $list['sleeve']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor25" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor25">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'look'; ?>','<?php echo 'uncheck'; ?>');" id="look" name="products[look][]" value="<?php echo $list['look']; ?>"><span>&nbsp;<?php echo $list['look']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'look'; ?>','<?php echo ''; ?>');" id="look" name="products[look][]" value="<?php echo $list['look']; ?>"><span>&nbsp;<?php echo $list['look']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor26" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor26">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'style_code'; ?>','<?php echo 'uncheck'; ?>');" id="style_code" name="products[style_code][]" value="<?php echo $list['style_code']; ?>"><span>&nbsp;<?php echo $list['style_code']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'style_code'; ?>','<?php echo ''; ?>');" id="style_code" name="products[style_code][]" value="<?php echo $list['style_code']; ?>"><span>&nbsp;<?php echo $list['style_code']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor27" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor27">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'inner_material'; ?>','<?php echo 'uncheck'; ?>');" id="inner_material" name="products[inner_material][]" value="<?php echo $list['inner_material']; ?>"><span>&nbsp;<?php echo $list['inner_material']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'inner_material'; ?>','<?php echo ''; ?>');" id="inner_material" name="products[inner_material][]" value="<?php echo $list['inner_material']; ?>"><span>&nbsp;<?php echo $list['inner_material']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div id="collapseProcessor28" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingProcessor28">
							...
							<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="itemwisefilters(this.value, '<?php echo 'waterproof'; ?>','<?php echo 'uncheck'; ?>');" id="waterproof" name="products[waterproof][]" value="<?php echo $list['waterproof']; ?>"><span>&nbsp;<?php echo $list['waterproof']; ?></span></label></div>
							<?php } else{  ?>
								<div class="checkbox"><label><input type="checkbox" onclick="itemwisefilters(this.value, '<?php echo 'waterproof'; ?>','<?php echo ''; ?>');" id="waterproof" name="products[waterproof][]" value="<?php echo $list['waterproof']; ?>"><span>&nbsp;<?php echo $list['waterproof']; ?></span></label></div>
							<?php } } ?>
							</div>
						</div>
					</div>
	 ...
	 <div  style="display:none;" class="alert dark alert-success alert-dismissible" id="sucessmsg"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
          ...
          <div class="title"><span><?php echo ucfirst(strtolower(isset($itemdetails['item_name'])?$itemdetails['item_name']:'')); ?>&nbsp; item wise Products lists</span></div>
...
function itemwisefilters(val,status,check){
	jQuery.ajax({
		
				url: "<?php echo site_url('category/itemwise_search');?>",
				type: 'post',

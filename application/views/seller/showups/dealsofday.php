...
<div class="content-wrapper mar_t_con" >
	<section class="content-header">
  	...
  	<section class="content ">
  		<div class="faq_main">
<a href="<?php echo base_url('seller/showups/adddealsofday');?>" class="btn btn-primary pull-right">Add</a>
...
<script type="text/javascript">
   ...
   <div class="container">
      ...
      <h1 class="head_title">Your Deals Of the Day List Is Empty Click add Button To Add Deals Of the Day.Thank You!</h1>

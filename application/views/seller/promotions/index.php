...
<?php if($this->session->flashdata('success')): ?>
	...
	<form  id="frm-example<?php echo $subcategory->subcategory_id;?>" name="frm-example<?php echo $subcategory->subcategory_id;?>" action="" method="POST">
        ...
        <thead>
            <tr>
              <th><input type="checkbox" name="select_all" onclick="checkall<?php echo $subcategory->subcategory_id;?>('<?php echo $subcategory->subcategory_id;  ?>','<?php echo $cnt; ?>');" id="example-select-all<?php echo $subcategory->subcategory_id;  ?>">&nbsp;<span class="btn btn-primary">Select All</span>
				</th>

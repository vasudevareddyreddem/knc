      ...
      <div class="">
        ...
        <div class="page-title">
          ...
          <div class="title_right pull-right">
            ...
            <form role="form" action="<?php echo base_url(); ?>admin/cancelledorders/search" method="post">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                ...
                <h2>Cancelled Orders</h2>
                               ...
                               <!-- <a href="<?php //echo base_url(); ?>admin/cancelledorders/create"><div class="btn btn-primary pull-right">Add cancelledorders</div></a>-->
...
//print_r($name_list);exit;
             ?>
                      ...
                      <td><a href="<?php echo base_url(); ?>admin/cancelledorders/view/<?php  echo $order_data->order_id; ?>"><i class="fa fa-eye" style="font-size:18px"></i></a></td>

                      <td><a href="<?php echo base_url(); ?>admin/cancelledorders/edit/<?php  echo $order_data->order_id; ?>"><i class="fa fa-pencil-square-o" style="font-size:18px"></i></a></td>

                      <td><a href="<?php echo base_url(); ?>admin/cancelledorders/delete/<?php  echo $order_data->order_id; ?>" onclick="return checkDelete('<?php  echo $order_data->order_id; ?>')"><i class="fa fa-trash" style="font-size:18px"></i></a></td>
